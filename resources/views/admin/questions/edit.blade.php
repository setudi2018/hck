            ...
            <div class="pull-right">
                <a href="{!! route('questions.index') !!}" class="btn btn-sm btn-primary btn-sm" rel="content-y"  role="button"><i class="fa fa-arrow-left"></i> Back</a>
                        ...
                        <div class="form-group row">
                             ...
                             <div class="col-sm-12 col-md-10">
                                <textarea name="a" placeholder="Option A">{!! $question->a !!}</textarea>
                        ...
                        <div class="form-group row">
                             ...
                             <div class="col-sm-12 col-md-10">
                                <textarea name="b" placeholder="Option B">{!! $question->b !!}</textarea>
                        ...
                        <div class="form-group row">
                             ...
                             <div class="col-sm-12 col-md-10">
                                <textarea name="c" placeholder="Option C">{!! $question->c !!}</textarea>
                        ...
                        <div class="form-group row">
                             ...
                             <div class="col-sm-12 col-md-10">
                                <textarea name="d" placeholder="Option D">{!! $question->d !!}</textarea>
                        ...
                        <div class="form-group row">
                             ...
                             <div class="col-sm-12 col-md-10">
                                <textarea name="more_info" placeholder="Option D">{!! $question->more_info !!}</textarea>
